...
from scripts.study_case.MatchZoo_py.matchzoo.dataloader import Dataset, DataLoader
from scripts.study_case.MatchZoo_py.matchzoo.datasets import embeddings
from scripts.study_case.MatchZoo_py.matchzoo.embedding import load_from_file
