...
import scripts.study_case.MatchZoo_py.matchzoo as matchzoo
from scripts.study_case.MatchZoo_py.matchzoo.engine.base_metric import (
...
def parse_loss(
    ...
    Examples::
        >>> from torch import nn
        >>> from scripts.study_case.MatchZoo_py.matchzoo.utils import parse_loss
...
def parse_metric(
    ...
    Examples::
        >>> from scripts.study_case.MatchZoo_py.matchzoo import metrics
        >>> from scripts.study_case.MatchZoo_py.matchzoo.utils import parse_metric
...
def parse_optimizer(
    ...
    Examples::
        >>> from torch import optim
        >>> from scripts.study_case.MatchZoo_py.matchzoo.utils import parse_optimizer
