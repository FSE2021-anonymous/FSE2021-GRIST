...
with tf.Session() as sess:
    ...
    while True:
        ...
        div1_val, div2_val, div3_val, div4_val = sess.run([div1, div2, div3, div4], feed_dict={X: batch_x, Y: batch_y})
        div1_val = np.min(np.abs(div1_val))
        div2_val = np.min(np.abs(div2_val))
        div3_val = np.min(np.abs(div3_val))
        div4_val = np.min(np.abs(div4_val))
        if step1 != 0 and div1_val == 0:
            step1 = step
        if step2 != 0 and div2_val == 0:
            step2 = step
        if step3 != 0 and div3_val == 0:
            step3 = step
        if step4 != 0 and div4_val == 0:
            step4 = step
        if step % 100 == 0:
            print(div1_val == 0, div2_val == 0, div3_val == 0, div4_val == 0, step1, step2, step3, step4)
            print(div1_val, div2_val, div3_val, div4_val)
