...
with tf.Session() as sess:
    ...
    while True:
        ...
        #     # print(k)
        #     var_val,grads_val = sess.run([var_list[k],obj_list[k]])
        #     #  = sess.run()
        #     # print(var_val, grads_val)
        #     delta = (var_val - 0) / grads_val
        #     i, j = index_list[k]
        #     random_variable_val[i][j] = var_val - delta
        # weights['l1'] = tf.assign(weights['l1'], random_variable_val)
