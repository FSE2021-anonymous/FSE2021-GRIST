# Success to find NaN!  Iteration: <372> Time cost: <0:00:09.864465>.
import numpy as np
...
change, drop_rate = float(sys.argv[1]), float(sys.argv[2])
...
def train(sess, batch_size=100, training_epochs=10, display_step=5):
    ...
    gradient_search = GradientSearcher(name="ch10_04_01_grist", drop_rate=drop_rate, change=change)
