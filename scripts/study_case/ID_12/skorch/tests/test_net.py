...
from scripts.study_case.skorch.skorch.utils import flatten
from scripts.study_case.skorch.skorch.utils import to_numpy
from scripts.study_case.skorch.skorch.utils import is_torch_data_type
...
class TestNeuralNet:
    ...
    def dummy_callback(self):
        from scripts.study_case.skorch.skorch.callbacks import Callback
    ...
    @pytest.fixture(scope='module')
    def net_cls(self):
        from scripts.study_case.skorch.skorch import NeuralNetClassifier
    ...
    def checkpoint_cls(self):
        from scripts.study_case.skorch.skorch.callbacks import Checkpoint
        return Checkpoint
    ...
    def test_save_and_load_from_checkpoint_formatting(
        ...
        from scripts.study_case.skorch.skorch.callbacks import EpochScoring
  ...
  module_=MLPModule(
    ...
    def test_fit_params_passed_to_module(self, net_cls, data):
        from scripts.study_case.skorch.skorch.toy import MLPModule
    ...
    def test_setting_callback_possible(self, net_cls, module_cls):
        from scripts.study_case.skorch.skorch.callbacks import EpochTimer, PrintLog
    ...
    def test_predefined_split(self, net_cls, module_cls, data):
        from scripts.study_case.skorch.skorch.dataset import Dataset
        from scripts.study_case.skorch.skorch.helper import predefined_split
