...
class TestCheckpoint:
    ...
    def net_cls(self):
        ...
        from scripts.study_case.skorch.skorch import NeuralNetRegressor
        from scripts.study_case.skorch.skorch.toy import make_regressor
    ...
    def test_init_with_dirname_and_file_like_object_error(
        ...
        from scripts.study_case.skorch.skorch.exceptions import SkorchException
...
class TestEarlyStopping:
    ...
    def early_stopping_cls(self):
        from scripts.study_case.skorch.skorch.callbacks import EarlyStopping
...
class TestParamMapper:
    ...
    def initializer(self):
        from scripts.study_case.skorch.skorch.callbacks import Initializer
        return Initializer

    @pytest.fixture
    def freezer(self):
        from scripts.study_case.skorch.skorch.callbacks import Freezer
        return Freezer

    @pytest.fixture
    def unfreezer(self):
        from scripts.study_case.skorch.skorch.callbacks import Unfreezer
        return Unfreezer

    @pytest.fixture
    def param_mapper(self):
        from scripts.study_case.skorch.skorch.callbacks import ParamMapper
        return ParamMapper
    ...
    def test_schedule_is_effective(self, net_cls, classifier_module,
        ...
        from scripts.study_case.skorch.skorch.utils import to_numpy, noop
        from scripts.study_case.skorch.skorch.utils import freeze_parameter, unfreeze_parameter
...
class TestLoadInitState:
    ...
    def loadinitstate_cls(self):
        from scripts.study_case.skorch.skorch.callbacks import LoadInitState
...
class TestTrainEndCheckpoint:
    ...
    def finalcheckpoint_cls(self):
        from scripts.study_case.skorch.skorch.callbacks import TrainEndCheckpoint
