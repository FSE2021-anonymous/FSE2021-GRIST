...
.. code-block:: python
    ...
    import torch
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.data import InMemoryDataset
...
.. code-block:: python
    ...
    import torch
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.data import Dataset
