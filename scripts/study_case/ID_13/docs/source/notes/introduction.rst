...
.. code-block:: python
    ...
    import torch
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.data import Data
...
.. code-block:: python
    ...
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.datasets import TUDataset
...
.. code-block:: python
    ...
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.datasets import Planetoid
...
.. code-block:: python
    ...
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.datasets import TUDataset
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.data import DataLoader
...
.. code-block:: python
    ...
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.datasets import ShapeNet
...
.. code-block:: python
    ...
    import scripts.study_case.pytorch_geometric_exp.torch_geometric.transforms as T
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.datasets import ShapeNet
...
.. code-block:: python
    ...
    from scripts.study_case.pytorch_geometric_exp.torch_geometric.nn import GCNConv
