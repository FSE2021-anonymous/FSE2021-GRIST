import torch
from scripts.study_case.pytorch_geometric_exp.torch_geometric.utils import degree, one_hot
...
class OneHotDegree(object):
    ...
    .. testcode::
        ...
        from scripts.study_case.pytorch_geometric_exp.torch_geometric.transforms import OneHotDegree
