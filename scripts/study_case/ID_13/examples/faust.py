...
from scripts.study_case.pytorch_geometric_exp.torch_geometric.datasets import FAUST
...
from scripts.study_case.pytorch_geometric_exp.torch_geometric.nn import SplineConv
