...
from scripts.study_case.pytorch_geometric_fork.torch_geometric.utils import to_scipy_sparse_matrix, to_networkx
from scripts.study_case.pytorch_geometric_fork.torch_geometric.utils import from_scipy_sparse_matrix, from_networkx
from scripts.study_case.pytorch_geometric_fork.torch_geometric.utils import subgraph
