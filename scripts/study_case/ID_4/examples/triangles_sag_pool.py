...
from scripts.study_case.pytorch_geometric_fork.torch_geometric.nn import GINConv, GCNConv, SAGPooling
from scripts.study_case.pytorch_geometric_fork.torch_geometric.nn import global_max_pool
