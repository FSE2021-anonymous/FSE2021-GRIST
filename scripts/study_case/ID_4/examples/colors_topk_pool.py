...
from scripts.study_case.pytorch_geometric_fork.torch_geometric.nn import GINConv, TopKPooling
from scripts.study_case.pytorch_geometric_fork.torch_geometric.nn import global_add_pool
