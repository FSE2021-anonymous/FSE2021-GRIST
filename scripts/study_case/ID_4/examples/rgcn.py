...
from scripts.study_case.pytorch_geometric_fork.torch_geometric.datasets import Entities
from scripts.study_case.pytorch_geometric_fork.torch_geometric.nn import RGCNConv
