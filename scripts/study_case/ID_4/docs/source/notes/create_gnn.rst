...
.. code-block:: python
    ...
    import torch
    from scripts.study_case.pytorch_geometric_fork.torch_geometric.nn import MessagePassing
    from scripts.study_case.pytorch_geometric_fork.torch_geometric.utils import add_self_loops, degree
...
.. code-block:: python
    ...
    from scripts.study_case.pytorch_geometric_fork.torch_geometric.nn import knn_graph
