...
.. code-block:: python
    ...
    import torch
    from scripts.study_case.pytorch_geometric_fork.torch_geometric.data import InMemoryDataset
...
.. code-block:: python
    ...
    import torch
    from scripts.study_case.pytorch_geometric_fork.torch_geometric.data import Dataset
...
#. **Do I really need to use these dataset interfaces?**
    ...
    .. code-block:: python
        ...
        from scripts.study_case.pytorch_geometric_fork.torch_geometric.data import Data, DataLoader
