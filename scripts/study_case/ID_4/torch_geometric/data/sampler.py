...
import scripts.study_case.pytorch_geometric_fork.torch_geometric
from scripts.study_case.pytorch_geometric_fork.torch_geometric.data import Data
from scripts.study_case.pytorch_geometric_fork.torch_geometric.utils import degree, segregate_self_loops
