...
from scripts.study_case.tensorflow_value_iteration_networks_v1.data import *
from scripts.study_case.tensorflow_value_iteration_networks_v1.model import *
from scripts.study_case.tensorflow_value_iteration_networks_v1.utils import *

np.random.seed(0)

# Data
tf.app.flags.DEFINE_string('input', '/data/scripts/study_case/tensorflow_value_iteration_networks_v1/data/gridworld_8.mat', 'Path to data')
...
cost = -tf.reduce_mean(tf.gather_nd(tf.expm1(nn), [cost_idx]))
...
obj_function = -1 * tf.reduce_max(global_obj_var)
